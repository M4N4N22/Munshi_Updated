...
**Scope:** Everything implemented from initial codebase through **Prompt 9** (AI reliability & evaluation)

> **Prompt 9 addendum:** Workflow intent datasets (400), document fixtures (44), eval harnesses, contract drift tests, classifier improvements. Backend tests: **119 passing**.
